 ...
 */
final class Version20180517010029 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE `match` (id INT AUTO_INCREMENT NOT NULL, id_squad1_id INT NOT NULL, id_squad2_id INT NOT NULL, date DATETIME NOT NULL, score1 INT NOT NULL, score2 INT NOT NULL, INDEX IDX_7A5BC505F35B78F (id_squad1_id), INDEX IDX_7A5BC5051D801861 (id_squad2_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
